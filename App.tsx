...
function App() {
  ...
  // evita enviar si ya está en proceso
  if (isSending) return;
  ...
  const SERVICE_ID = "service_fab0zmb"
  const TEMPLATE_ID = "template_g8vc5wr"
  const PUBLIC_KEY = "kI9N5SNF8ZsmDs7vh"
  ...
  try {
    ...
    alert("❌ Ocurrió un error al enviar. Reintentá o verificá la consola.");
  } finally {
    setIsSending(false);
  }
};
